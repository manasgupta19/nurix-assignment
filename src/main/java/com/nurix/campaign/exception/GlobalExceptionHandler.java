...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles Resource Not Found (e.g., searching for a non-existent campaign).
     */
    ...
    /**
     * Handles CSV Processing failures and empty files.
     */
    ...
    /**
     * Handles JSR-303 Validation Errors (e.g., @Min, @Max, @NotBlank).
